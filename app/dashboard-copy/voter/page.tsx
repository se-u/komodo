...
export const columns: ColumnDef<Voter>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="lowercase">{row.getValue("idCard")}</div>
    ),
  },
  {
    accessorKey: "address",
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="capitalize">
        {row.getValue("isVerified") ? "Verified" : "NotVerified"}
      </div>
    ),
  },
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem>
              <DeleteVoter id={row.getValue("id")} />
            </DropdownMenuItem>
            <DropdownMenuItem>
              <UpdateVoter id={row.getValue("id")} />
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      );
...
export default function Voter({
  ...
  const [data, setData] = React.useState<Voter[]>([]);
  console.log(data);
  ...
  React.useEffect(() => {
    const test = async () => {
      ...
      let voters: Voter[] = _voters.filter(
        (voter: { name: string; idCard: string }) => {
          return (
